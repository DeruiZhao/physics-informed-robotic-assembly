...
output_dir = "column_assembly_flexible_1.05_elastic_1.6_steps_screenshots"
os.makedirs(output_dir, exist_ok=True)
video_filename = os.path.join(output_dir, "column_assembly_flexible_1.05_elastic_1.6_viz.mp4")
...
paths_file = "column_assembly_paths_flexible_1.05_elastic_1.6.json"
try:
...
deformation_file = "column_deformation_data_flexible_1.05_elastic_1.6.json"
try:
