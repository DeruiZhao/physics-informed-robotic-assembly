...
output_dir = "column_assembly_rigid_elastic_0.1_steps_screenshots"
...
paths_file = "column_assembly_paths_rigid_elastic_0.1.json"
try:
...
deformation_file = "column_deformation_data_rigid_elastic_0.1.json"
try:
