...
# Create supports
supports_geometry = get_cylinder_geometry(0.005, 0.084)
supports_ori = p.getQuaternionFromEuler([0, 0, 0])
supports_1_pose = ([0.4400000005960465, 0.13071796666486218, 0.142], supports_ori)
supports_2_pose = ([0.4399999986250829, 0.2692820321972015, 0.142], supports_ori)
supports_3_pose = ([0.3200000007788707, 0.20000000113793634, 0.142], supports_ori)
...
output_dir = "column_assembly_steps_screenshots"
...
paths_file = "column_assembly_paths.json"
try:
